...
//            wxAfterOpenPre.setSummary(wxAfterOpenPre.getEntries()[value]);
            ...
            final EditTextPreference delayEditTextPre = (EditTextPreference) findPreference(Config.KEY_WECHAT_OPEN_DELAY_TIME);
            ...
            final EditTextPreference delayEditTextClick = (EditTextPreference) findPreference(Config.KEY_WECHAT_CLICK_DELAY_TIME);
            delayEditTextClick.setOnPreferenceChangeListener(new Preference.OnPreferenceChangeListener() {
                @Override
                public boolean onPreferenceChange(Preference preference, Object newValue) {
                    if ("0".equals(String.valueOf(newValue))) {
                        preference.setSummary("");
            ...
            String clickDelay = delayEditTextClick.getText();
            if ("0".equals(String.valueOf(clickDelay))) {
                delayEditTextClick.setSummary("");
            } else {
                delayEditTextClick.setSummary("已延时" + delay + "毫秒");
            }

            final EditTextPreference delayEditTextBack = (EditTextPreference) findPreference(Config.KEY_WECHAT_BACK_DELAY_TIME);
            delayEditTextBack.setOnPreferenceChangeListener(new Preference.OnPreferenceChangeListener() {
                @Override
                public boolean onPreferenceChange(Preference preference, Object newValue) {
                    if ("0".equals(String.valueOf(newValue))) {
                        preference.setSummary("");
            ...
            String backDelay = delayEditTextBack.getText();
            if ("0".equals(String.valueOf(backDelay))) {
                delayEditTextBack.setSummary("");
            } else {
                delayEditTextBack.setSummary("已延时" + delay + "毫秒");
            }
        }
    }
}
